...
<div class="row border-only-bottom background-white">
        <div class="text-center col-6 offset-0 "></div>
        <div class="col-1"></div>
        <div class="col-5" style="font-weight: bold; text-align: center;">Jahr 0</div>
    </div>
    <div class="row background-white">
        <div style="word-wrap: break-word;" class="text-center col-6 offset-0 profitLossStyle">Umsatzerlöse</div>
    ...
    <div class="row background-white">
        <div style="word-wrap: break-word;" class="text-center col-6 offset-0 border-only-bottom profitLossStyle">Herstellungskosten</div>
    ...
    <div class="row background-white">
        <div style="word-wrap: break-word;" class=" text-center col-6 offset-0 background-yellow profitLossStyle">Bruttoergebnis</div>
        <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">=</div>
        <div id="bruttoergebnis" class="col-5 background-yellow profitLossStyle" style="text-align: center;"></div>
    </div>
    <div class="row background-white">
        <div style="word-wrap: break-word;" class="text-center col-6 offset-0 profitLossStyle">Forschung & Entwicklung</div>
        <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">-</div>
        <div class="col-5 border-only-bottom profitLossStyle" style="text-align: center;">
    ...
    <div class="row background-white">
        <div style="word-wrap: break-word;" class="text-center col-6 offset-0 profitLossStyle">Verwaltung</div>
        <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">-</div>
        <div class="col-5 border-only-bottom profitLossStyle" style="text-align: center;">
    ...
    <div class="row background-white">
        <div style="word-wrap: break-word;" class="text-center col-6 offset-0 profitLossStyle">Marketing & Vertrieb</div>
        <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">-</div>
        <div class="col-5 border-only-bottom profitLossStyle" style="text-align: center;">
    ...
    <div class="row background-white">
        <div style="word-wrap: break-word;" class="text-center col-6 offset-0 profitLossStyle">Sonstige betriebliche Erträge</div>
        <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+</div>
        <div class="col-5 border-only-bottom profitLossStyle" style="text-align: center;">
    ...
    <div class="row background-white">
        <div style="word-wrap: break-word;" class="text-center col-6 offset-0 border-only-bottom profitLossStyle">Abschreibung</div>
        <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">-</div>
        <div class="col-5 border-only-bottom profitLossStyle" style="text-align: center;">
    ...
    <div class="row background-white">
        <div style="word-wrap: break-word;" class="text-center col-6 offset-0 background-yellow profitLossStyle">Betriebsergebnis (EBIT)</div>
        <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">=</div>
        <div id="betriebsergebnis" class="col-5 background-yellow border-only-bottom profitLossStyle" style="text-align: center;"></div>
    </div>
    <div class="row background-white">
        <div style="word-wrap: break-word;" class="text-center col-6 offset-0 border-only-bottom profitLossStyle">Zinsen</div>
        <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">-</div>
        <div class="col-5 border-only-bottom profitLossStyle" style="text-align: center;">(3)</div>
    </div>
    <div class="row background-white">
        <div style="word-wrap: break-word;" class="text-center col-6 offset-0 background-yellow profitLossStyle">Ergebnis vor Steuern (EBIT)</div>
        <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">=</div>
        <div class="col-5 background-yellow border-only-bottom profitLossStyle" style="text-align: center;">6</div>
    </div>
    <div class="row background-white">
        <div style="word-wrap: break-word;" class="text-center col-6 offset-0 border-only-bottom profitLossStyle">Steuern vom Ergebnis (1/3)</div>
        <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">-</div>
        <div class="col-5 border-only-bottom profitLossStyle" style="text-align: center;">(2)</div>
    </div>
    <div class="row background-white">
        <div style="word-wrap: break-word;" class="text-center col-6 offset-0 background-yellow profitLossStyle">Ergebnis nach Steuern (EAT)</div>
        <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">=</div>
        <div class="col-5 background-yellow border-only-bottom profitLossStyle" style="text-align: center;">4</div>
    </div>
