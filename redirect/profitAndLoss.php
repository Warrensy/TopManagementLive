...
<div class="accordion" id="accordionExample">
    ...
    ?>
        ...
        <div class="card">
            ...
            <div id="a<?php echo $i; ?>" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                <div class="card-body">
                    ...
                    <form method="POST">
                        <div class="container-fluid">
                            ...
                            <div class="row background-white">
                                ...
                                <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">-</div>
                                <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;"></div>
                            </div>
                            <div class="row background-white">
                                <div style="word-wrap: break-word;" class="col-5 offset-2 background-yellow profitLossStyle">Ergebnis vor Steuern (EBIT)</div>
                                <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">=</div>
                                <div class="col-2 background-yellow border-only-bottom profitLossStyle" style="text-align: center;"></div>
                            </div>
                            <div class="row background-white">
                            ...
                            <div class="row background-white">
                                ...
                                <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">=</div>
                                <div id="ergebnisnachsteuern" class="col-2 background-yellow border-only-bottom profitLossStyle" style="text-align: center;"></div>
                            </div>
...
?>
    <script>
        ...
        document.getElementById("steuernvomergebnis").value = <?php echo $steuernvomergebnis; ?>;

        document.getElementById("ergebnisnachsteuern").innerHTML = <?php echo $ergebnisnachsteuern; ?>;
