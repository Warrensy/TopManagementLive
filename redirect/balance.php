...
<form method="POST">
    ...
    <div class="row border-only-bottom background-white">
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle" style="font-weight: bold;">Aktiva</div>
            <div class="col-1"></div>
            <div style="word-wrap: break-word;" class="col-2" style="font-weight: bold; text-align: center;">Jahr 0</div>
            <div style="word-wrap: break-word;" class="col-3 border-only-left" style="font-weight: bold;">Passiva</div>
            <div class="col-1"></div>
            <div style="word-wrap: break-word;" class="col-2 profitLossStyle"style="font-weight: bold; text-align: center;">Jahr 0</div>
        </div>
        <div class="row background-white">
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle ">Immaterielle Vermögensgegenstände</div>
            ...
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle border-only-left">Gezeichnetes Kapital</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+</div>
            <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;">
        ...
        <div class="row background-white">
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle">Grundstücke</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+</div>
            <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;">
                <input class="form-control" min="0" required name="grundstücke" type="number" id="grundstücke" onInput="$('#grundstücke').html($(this).val())">
            </div>
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle border-only-left">Kapitalrücklage</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+</div>
            <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;">
        ...
        <div class="row background-white">
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle">Gebäude</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+</div>
            <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;">
                <input class="form-control" min="0" required name="gebauude" type="number" id="gebauude" onInput="$('#gebauude').html($(this).val())">
            </div>
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle border-only-left">Gewinnrücklage</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+</div>
            <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;">
        ...
        <div class="row background-white">
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle">Technische Anlagen</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+</div>
            <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;">
                <input class="form-control" min="0" required name="anlagen" type="number" id="anlagen" onInput="$('#anlagen').html($(this).val())">
            </div>
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle border-only-left border-only-bottom">Ergebnis nach Steuern</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+/-</div>
            <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;">
        ...
        <div class="row background-white">
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle border-only-bottom">Betriebs- und Geschäftsausstattung</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+</div>
            <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;">
                <input class="form-control" min="0" required name="BundG" type="number" id="BundG" onInput="$('#BundG').html($(this).val())">
            </div>
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle border-only-left background-yellow">Summe Eigenkapital</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">=</div>
            <div id="summeeigenkapital" class="col-2 border-only-bottom profitLossStyle background-yellow" style="text-align: center;"></div>
        </div>
        <div class="row background-white">
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle background-yellow">Summe Anlagevermögen</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">=</div>
        ...
        <div class="row background-white">
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle">Vorräte:</div>
            <div class="col-1 profitLossStyle"></div>
            <div class="col-2 profitLossStyle" style="text-align: center;"></div>
            <div style="word-wrap: break-word;"class="col-3 profitLossStyle border-only-left">Rückstellungen</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+</div>
            <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;">
        ...
        <div class="row background-white">
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle">Roh-, Hilfs- und Betriebsstoffe</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+</div>
            <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;">
                <input class="form-control" min="0" required name="rhb" type="number" id="rhb" onInput="$('#rhb').html($(this).val())">
            </div>
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle border-only-left">Finanzverbindlichkeiten</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+</div>
            <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;">
        ...
        <div class="row background-white">
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle">Unfertige Erzeugnisse</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+</div>
            <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;">
            ...
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle border-only-left">Verbindl. aus L&L</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+</div>
            <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;">
        ...
        <div class="row background-white">
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle">Fertige Erzeugnisse</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+</div>
            <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;">
            ...
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle border-only-left border-only-bottom">Sonstige Verbindlichk.</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+</div>
            <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;">
        ...
        <div class="row background-white">
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle">Forderungen</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+</div>
            <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;">
                <input class="form-control" min="0" required name="forderungen" type="number" id="forderungen" onInput="$('#forderungen').html($(this).val())">
            </div>
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle border-only-left background-yellow">Summe Fremdkapital</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">=</div>
            <div id="summefremdkapital" class="col-2 border-only-bottom profitLossStyle background-yellow" style="text-align: center;"></div>
        </div>
        <div class="row background-white">
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle border-only-bottom">Flüssige Mittel</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">+</div>
            <div class="col-2 border-only-bottom profitLossStyle" style="text-align: center;">
        ...
        <div class="row background-white">
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle background-yellow border-only-bottom">Summe Umlaufverm.</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">=</div>
        ...
        <div class="row background-white">
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle background-yellow">Summe Aktiva</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">=</div>
            <div  id="summeaktiva" class="col-2 background-yellow border-only-bottom profitLossStyle" style="text-align: center;"></div>
            <div style="word-wrap: break-word;" class="col-3 profitLossStyle border-only-left background-yellow">Summe Passiva</div>
            <div class="col-1 profitLossStyle" style="font-weight: bold; text-align: center;">=</div>
